...
function theory_course() {
	...
	textBox[1].value = setRandomValueFromArray(teacherWeaknesses, 1);
	...
	textBox[3].value = setRandomValueFromArray(courseWeaknesses, 3);
	...
	textBox[4].value = setRandomValueFromArray(suggestions, 4);
...
function lab_course() {
	...
	textBox[2].value = setRandomValueFromArray(suggestions, 2);
